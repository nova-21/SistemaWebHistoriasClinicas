...
def obtener_historial(buscar):
    ...
    cedula, nombre, fecha_nacimiento, ocupacion, estado_civil = paciente
    conn = None
    try:
        ...
        with st.sidebar:
            ...
            colored_header(
                ...
                color_name="red-50",
                description="")
            st.button("Registrar nueva sesión", on_click=cambiar_pagina_cita)
        ...
        if sesion_seleccionada:
            ...
            if editar_sesion:
                ...
                with placeholder:
                    ...
                    asistencia = st.text_area("Asuntos tratados en la sesión", value=resultado_sesion[0])
                ...
                colored_header(
                    ...
                    color_name="red-50",
                    description="")
                informacion, archivos_adjuntos = st.tabs(["Información", "Archivos adjuntos"])
                with informacion:
